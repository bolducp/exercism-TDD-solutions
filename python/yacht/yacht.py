...
def score(dice, category):
    score_funcs = {
        ...
        LITTLE_STRAIGHT: partial(score_straight, straight=[1, 2, 3, 4, 5]),
        BIG_STRAIGHT: partial(score_straight, straight=[2, 3, 4, 5, 6]),
        CHOICE: score_choice,
    }
...
def score_straight(straight, dice):
    if sorted(dice) == straight:
        return 30
    return 0
